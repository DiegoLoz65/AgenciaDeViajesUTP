 ...
 */
public class Plan2 extends ConstruirPaquete{
    ...
    public void construirHotel() {
         ...
         try{
            ...
            sql = "SELECT * FROM hoteles WHERE ID = 2";
    ...
    public void construirBus() {
        ...
        try{
            ...
            sql = "SELECT * FROM buses WHERE ID = 2";
            PreparedStatement ps = cn.prepareStatement(sql);
            myRs = ps.executeQuery();
            while(myRs.next()){
                Nombre = myRs.getString("Nombre");
    ...
    public void construirVuelo() {
        ...
        try{
            ...
            sql = "SELECT * FROM vuelos WHERE ID = 2";
            PreparedStatement ps = cn.prepareStatement(sql);
            myRs = ps.executeQuery();
            while(myRs.next()){
    ...
    public void construirOperador() {
        ...
        try{
            ...
            sql = "SELECT * FROM operadores WHERE ID = 2";
            PreparedStatement ps = cn.prepareStatement(sql);
            myRs = ps.executeQuery();
            while(myRs.next()){
                Nombre = myRs.getString("Nombre");
    ...
    public void construirNombrePlan() {
        paquete.setNombrePlan("Plan Invierno");
    }

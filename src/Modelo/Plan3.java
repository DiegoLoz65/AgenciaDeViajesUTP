 ...
 */
public class Plan3 extends ConstruirPaquete{
    ...
    public void construirHotel() {
         ...
         try{
            ...
            sql = "SELECT * FROM hoteles WHERE ID = 3";
    ...
    public void construirBus() {
        ...
        try{
            ...
            sql = "SELECT * FROM buses WHERE ID = 3";
            PreparedStatement ps = cn.prepareStatement(sql);
            myRs = ps.executeQuery();
            while(myRs.next()){
                Nombre = myRs.getString("Nombre");
    ...
    public void construirVuelo() {
        ...
        try{
            ...
            sql = "SELECT * FROM vuelos WHERE ID = 3";
            PreparedStatement ps = cn.prepareStatement(sql);
            myRs = ps.executeQuery();
            while(myRs.next()){
    ...
    public void construirOperador() {
        ...
        try{
            ...
            sql = "SELECT * FROM operadores WHERE ID = 3";
            PreparedStatement ps = cn.prepareStatement(sql);
            myRs = ps.executeQuery();
            while(myRs.next()){
                Nombre = myRs.getString("Nombre");
    ...
    public void construirNombrePlan() {
        paquete.setNombrePlan("Plan Otoño");
    }
